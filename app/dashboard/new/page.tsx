            ...
            <header className="sticky top-0 z-50 border-b border-white/5 bg-slate-950/80 backdrop-blur-xl">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/dashboard">
                            <Button variant="outline" className="border-white/10 text-slate-300 hover:bg-white/5 hover:text-white">← Back to Dashboard</Button>
                        </Link>
                    </div>
                </div>
            </header>
                ...
                <div className="bg-slate-900/50 backdrop-blur-sm border border-white/5 rounded-2xl shadow-xl p-8">
                    ...
                    {!structured && (
                        <div className="mb-8 flex gap-2 border-b border-white/5 pb-4">
                            <button
                                onClick={() => setMode('ai')}
                                className={`px-6 py-3 rounded-lg font-medium transition-all ${mode === 'ai'
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-lg font-medium transition-all ${mode === 'manual'
                                    ? 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-lg shadow-indigo-500/25'
                                    : 'bg-white/5 text-slate-400 hover:bg-white/10 hover:text-white'
                                    }`}
                            >
