...
export default function DecisionDetailPage() {
    ...
    const handleToggleLock = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setDecision(updated);
                setEditing(false); // Exit edit mode if locking
            }
        } catch (err) {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-950">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-slate-400">Loading decision...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-slate-950 selection:bg-violet-500/30 text-slate-200">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                {decision.is_locked ? '🔓 Unlock' : '🔒 Lock'}
                            </Button>
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
                <div className="bg-slate-900/50 backdrop-blur-sm border border-white/5 rounded-2xl shadow-xl p-8 print:shadow-none print:bg-white print:border-gray-200 print:text-black">
                    ...
                    <div className="flex gap-2 mb-4 no-print">
                        {decision.is_locked && (
                            <span className="px-3 py-1 bg-slate-800 text-slate-300 rounded-full text-sm font-medium border border-white/5">
                                🔒 Locked
                            </span>
                        )}
                        {decision.ai_structured && (
                            <span className="px-3 py-1 bg-indigo-500/10 text-indigo-300 rounded-full text-sm font-medium border border-indigo-500/20">
                                ✨ AI-Structured
                            </span>
                        )}
                    </div>
                    ...
                    {editing ? (
                        <div className="space-y-6">
                            <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-lg p-4 mb-4">
                                <p className="text-sm text-indigo-300">
                                    ✏️ <strong>Edit Mode</strong> - Make changes and save, or cancel to discard.
                                </p>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4 print:border print:border-gray-300 print:bg-amber-50">
                                <h2 className="text-sm font-semibold text-amber-400 uppercase mb-2 print:text-amber-800">
                                    ⚠️ Biggest Risk
                                </h2>
                                <p className="text-slate-300 leading-relaxed whitespace-pre-wrap print:text-gray-800">
                            ...
                            {decision.confidence_level && (
                                <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="flex-1 bg-slate-800 rounded-full h-3 max-w-xs print:bg-gray-200">
                                            <div
                                                className="bg-indigo-500 h-3 rounded-full transition-all print:bg-blue-600"
                            ...
                            {decision.original_input && (
                                <details className="border-t border-white/5 pt-4 no-print">
                                    <summary className="text-sm font-semibold text-slate-400 uppercase cursor-pointer hover:text-indigo-400">
                                        📝 Original Input (AI-Structured)
                                    </summary>
            ...
            {showDeleteConfirm && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 no-print">
